...
import (
	...
	"github.com/colincassens/cosmosCheckers/testutil/sample"
	cosmoscheckerssimulation "github.com/colincassens/cosmosCheckers/x/cosmoscheckers/simulation"
...
const (
	...
	opWeightMsgRejectGame = "op_weight_msg_create_chain"
	// TODO: Determine the simulation weight value
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgCreateGame,
		cosmoscheckerssimulation.SimulateMsgCreateGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgPlayMove,
		cosmoscheckerssimulation.SimulateMsgPlayMove(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgRejectGame,
		cosmoscheckerssimulation.SimulateMsgRejectGame(am.accountKeeper, am.bankKeeper, am.keeper),
	))
